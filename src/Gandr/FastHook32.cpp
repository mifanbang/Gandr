/*
 *  Gandr - yet another minimalism library for debugging
...
const SupportedProlog32::PrologSupportList SupportedProlog32::s_supportedPrologs = { {
...
const Prolog32& SupportedProlog32::GetProlog(PrologType32 type) noexcept
{
	return s_supportedPrologs[static_cast<size_t>(type)].first;
}


PrologType32 SupportedProlog32::GetType(const Prolog32& prolog) noexcept
{
...
void* SupportedProlog32::GetTrampoline(PrologType32 type) noexcept
{
	switch (type) {
...
PrologType32 PrologTable32::Query(const void* func) noexcept
{
	return s_prologTableData.ApplyOperation( [func] (const PrologTableData32& data) -> auto {
		...
		if (itr == data.end()) {
			...
			auto type = SupportedProlog32::GetType(prolog);
			Register(func, type);
			return type;
		}
...
FastHook32::HookResult FastHook32::Hook() noexcept
{
	...
	m_prologType = SupportedProlog32::GetType(prolog);
...
FastHook32::HookResult FastHook32::Unhook() noexcept
{
	...
	auto prolog = SupportedProlog32::GetProlog(type);
